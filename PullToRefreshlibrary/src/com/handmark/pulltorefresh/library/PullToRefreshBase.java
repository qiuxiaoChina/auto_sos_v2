...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private OnRefreshScrollDeltaChangedListener changedListener;
        ...
        switch (getPullToRefreshScrollDirection()) {
            case VERTICAL:
                if (changedListener != null) {
                    changedListener.onScrollDelta(value);
                }
                scrollTo(0, value);
                break;
            case HORIZONTAL:
    ...
    public void setRefreshScrollDeltaChangedListener(OnRefreshScrollDeltaChangedListener changedListener) {
    ...
    public interface OnRefreshScrollDeltaChangedListener {
