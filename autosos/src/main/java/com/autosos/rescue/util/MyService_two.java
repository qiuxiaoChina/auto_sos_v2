...
public class MyService_two extends Service {


    private static final int NOTIFICATION_ID = 1; // 如果id设置为0,会导致不能设置为前台service

    PowerManager.WakeLock wakeLock = null;
    public MyService_two() {
    }
    ...
    public void onDestroy() {
        ...
        releaseWakeLock();
        stopForeground(true);
        Intent intent = new Intent(this,MyService_two.class);
        startService(intent);
    }
        ...
        public void run() {
            ...
            TimerTask task = new TimerTask() {
                ...
                public void run() {
                    ...
                    boolean b = isServiceWorked(MyService_two.this, "qiuxiao.com.servicedemo.MyService_one");
                    if(!b) {
                        Intent service = new Intent(MyService_two.this, MyService_one.class);
