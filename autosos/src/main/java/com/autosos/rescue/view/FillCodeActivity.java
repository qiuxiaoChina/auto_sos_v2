...
import com.autosos.rescue.widget.MyCountTimer;
import com.autosos.rescue.widget.SmsContent;
                ...
                try {
                    ...
                    if (!jsonObject.isNull("result")) {
                        ...
                        if (result == 1) {
                            ...
                            Toast.makeText(FillCodeActivity.this, msg, Toast.LENGTH_SHORT).show();
                        }
                    }
